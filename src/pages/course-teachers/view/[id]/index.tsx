...
import { getCourseTeacherById } from 'apiSdk/course-teachers';
...
function CourseTeacherViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Course Teacher Detail View
          </Text>
          {hasAccess('course_teacher', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/course-teachers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
